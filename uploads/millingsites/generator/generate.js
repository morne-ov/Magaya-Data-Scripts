...
const inputPath = path.join(__dirname, '../data/example_millingsites.csv');
const outputPath = path.join(__dirname, '../output/insert_millingsites.sql');
...
const sql = `-- Insert milling sites from: example_millingsites.csv
-- ${values.length} milling sites
