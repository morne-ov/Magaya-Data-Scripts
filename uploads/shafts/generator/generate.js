...
const inputPath = path.join(__dirname, '../data/example_shafts.csv');
const outputPath = path.join(__dirname, '../output/insert_shafts.sql');
...
const sql = `-- Insert shafts from: example_shafts.csv
-- ${values.length} shafts
